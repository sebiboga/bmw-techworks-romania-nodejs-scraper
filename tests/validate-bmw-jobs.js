/**
 * BMW Job Validator - Check and remove expired jobs
 * 
 * Validates all BMW jobs from peviitor API and deletes expired (404) ones from SOLR.
 * Run: node tests/validate-bmw-jobs.js
 */
