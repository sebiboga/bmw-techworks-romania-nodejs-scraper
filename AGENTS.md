...
## Project
BMW TechWorks Romania scraper for peviitor.ro (Node.js, ESM, Jest)
...
# E2E tests (real BMW feed, SOLR conditional)
...
- `company.js` — company validation (brand search + ANAF + Peviitor + SOLR)
- `solr.js` — SOLR operations
- `index.js` — main scraper orchestrator
- `fix-bmw-data.js` — repair BMW jobs from other scrapers
